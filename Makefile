...
# Generated by qmake (1.07a) (Qt 3.3.8b) on: Mon Apr 20 15:28:41 2009
...
LEX      = flex
YACC     = yacc
CFLAGS   = -pipe -g -O2 -D_REENTRANT  -DQT_NO_DEBUG -DQT_THREAD_SUPPORT
CXXFLAGS = -pipe -g -O2 -D_REENTRANT  -DQT_NO_DEBUG -DQT_THREAD_SUPPORT -DHAVE_NAMESPACE_STD -DHAVE_CXX_STRING_HEADER -DDLLIMPORT=""
LEXFLAGS = 
YACCFLAGS= -d
INCPATH  = -I/usr/share/qt3/mkspecs/default -I. -I/usr/local/pgsql/include -I/usr/include/qt3
LINK     = g++
LFLAGS   = 
LIBS     = $(SUBLIBS) -L/usr/share/qt3/lib -L/usr/X11R6/lib -L/usr/local/pgsql/lib -lpq++ -lqt-mt -lXext -lX11 -lm -lpthread
AR       = ar cqs
RANLIB   = 
...
Makefile: mtserver.pro  /usr/share/qt3/mkspecs/default/qmake.conf 
